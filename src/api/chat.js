export default async function handler(req, res) {
  ...
  // گرفتن کلید امنیتی از تنظیمات مخفی ورسل
  ...
  // تبدیل پیام‌ها به ساختار مورد نیاز Claude API
  ...
  // متن پرامپت اصلی (مغز متفکر و مواضع عقیدتی ربات)
  const systemPrompt = `
  ...
  try {
    const response = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        model: 'claude-3-flash-20241022', // استفاده از مدل سریع و بهینه‌ی کلود ۳
        max_tokens: 2000,
        system: systemPrompt,
